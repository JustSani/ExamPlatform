...
router.use("/",function(req,res,next){
    if(req.originalUrl.includes("login.html"))
        ...
        getFile("./static/html/index.html", res)
    else if(req.originalUrl.includes("home.html"))
        getFile("./static/html/home.html", res)
    else if(req.originalUrl.includes("profile.html"))
        getFile("./static/html/profile.html", res)
    else if(req.originalUrl.includes("registro.html"))
        getFile("./static/html/registro.html", res)
    else if(req.originalUrl.includes("tests.html"))
